  ...
  return (
    <>
        ...
        <nav>
          <ul className="menu">
            <li>
              <Link
                to="/"
                className={`visit ${activeP}`}
                onClick={() => handleBack("p")}
              >
                About
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/training"
                className={`visit ${activeT}`}
                onClick={() => handleBack("t")}
              >
                Experience
              </Link>
            </li>
      ...
      <section className="intro container">
        ...
        <p className="portfolio-word">FULL STACK DEVELOPER</p>
      </section>
    </>
  );
};
